...
class CampaignUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'name'=>"required|max:20|unique:campaigns,name,{$this->id}",
    ...
    public function messages()
    {
        ...
        if (App::getLocale() == 'en') {
            return [
                ...
                'name.unique' => 'يجب أن لا يتكرر الاسم أكثر من مرة, الاسم موجود مسبقاً',
                ...
                'end_date.after' => 'يجب ان يكون التاريخ الاول قبل التاريخ الثاني',
