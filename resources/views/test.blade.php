...
<head>
  ...
  {{-- <div class="container">
    <label for="exampleFormControlInput1" >Choose an excel file to import LEADS from</label>
    <input style="width: 30em" type="file" accept=".xlsx, .xls, .csv" class="form-control">

    <br>
    <button class="btn btn-primary" onclick="myFunction()" type="submit">DONE</button>
</div> --}}
    <meta charset="utf-8">
